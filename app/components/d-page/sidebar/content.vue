...
import { LogOutIcon, PanelLeftClose, PanelRightClose, SaveIcon, XIcon, FolderIcon, FoldersIcon, FileIcon, ReceiptIcon, UsersRoundIcon } from "lucide-vue-next"
...
const organisationName = ref("Invoice")
  ...
  <nav class="flex flex-col gap-0.5 p-2">
    <div class="group flex h-9 cursor-default items-center justify-between gap-2 rounded-md text-sm text-neutral-700">
      <div v-show="!collapsed" class="flex items-center gap-2 px-2 py-2">
        <img src="/favicon.ico" class="size-5" />
